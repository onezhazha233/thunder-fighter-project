...
if(sequence_exists(flame)){
	flame_sequence = layer_sequence_create(lel,x+lengthdir_x(flame_x_offset-surf_x*surf_enabled,image_angle),y+lengthdir_y(flame_y_offset-surf_y*surf_enabled,image_angle),flame);
