	...
	if(start = 1){
		...
		if(start = 1){
			if(time = 1){
				...
				Anim_Create(id,"x",0,0,x,target1_x-x,40);
				Anim_Create(id,"y",0,0,y,target1_y-y,40);
				Anim_Create(id,"x",0,0,target1_x,target2_x-target1_x,40,40);
				Anim_Create(id,"y",0,0,target1_y,target2_y-target1_y,40,40);
			}
			if(time > 80){
