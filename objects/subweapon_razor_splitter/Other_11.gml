live;
blt = MakePlayerBullet(x-35*scale_x,y,bullet_player_splitter,seq_splitter_b_intro_rampage)
blt.idle = seq_splitter_b_rampage
blt.small_sequence = seq_splitter_b_small_rampage
