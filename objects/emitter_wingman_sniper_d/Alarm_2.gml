live;
blt = MakePlayerBullet(x,y,bullet_player_wingman_sniper_d)
...
array_push(follow_inst,[fire,lengthdir_x(60*scale_x,blt.direction),lengthdir_y(60*scale_y,blt.direction)])