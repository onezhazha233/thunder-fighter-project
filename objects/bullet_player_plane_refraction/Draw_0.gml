...
refraction_angle[1] = 135
refraction_angle[2] = 45
...
for(i=0;i<refraction_amount;i+=1){
	...
	find = laser_find_width(refraction_start_x[i],refraction_start_y[i],refraction_angle[i],range,sprite_get_width(laser_sprite)*image_xscale*scale_x*0.4,enemy_agent,true,true,ignoreInstances)
	...
	draw_laser(laser_sprite,0,refraction_start_x[i],refraction_start_y[i],laser_offset,refraction_angle[i],refraction_length[i],true,image_xscale*scale_x,image_yscale*scale_y,image_alpha)
