...
if(wave_effect = true){
	...
	var w = sprite_get_width(sprite_wave)*3;
	var h = sprite_get_height(sprite_wave);
	...
	if(w_px > 0){
		...
		for(var i=-1;i<count;i+=1){
			...
			if(i>0)draw_sprite_ext(sprite_lighting,4-wave_image,w/2+30*wave_xscale,h*i-60,-wave_xscale,1,180,-1,1);
			draw_sprite_ext(sprite_lighting,4-wave_image,w/2-30*wave_xscale,h*i-150+wo,wave_xscale,wys,180,-1,1);
			draw_sprite_ext(sprite_wave,0,w/2,h*i+wave_offset,wave_xscale*xs,ys,180,-1,al);
		}
