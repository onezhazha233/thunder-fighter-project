...
if(state >= 1){
	if(laser_scale > 0){
		...
		if(start_effect = true){
			draw_sprite_ext(sprite_ring,0,x,y,laser_scale*choose(1,-1)*1.4,laser_scale*image_xscale/2,image_angle+90,-1,image_alpha/2);
			draw_sprite_ext(sprite_start_effect,0,x,y,laser_scale*choose(1,-1)*1.4,laser_scale*image_xscale/2,choose(0,180)+image_angle+90,-1,image_alpha/2);
		}
