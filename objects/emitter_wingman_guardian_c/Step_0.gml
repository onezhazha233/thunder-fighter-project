...
if(enabled = true){
	...
	if(time > 0){
		if(rampage = false){
			damage = 0.645833;
			switch(weapon_level){
				case 0:damage = 0.645833*global.atk_wingman;break;
				case 1:damage = 0.6296875*global.atk_wingman;break;
				case 2:damage = 0.65875*global.atk_wingman;break;
				case 3:damage = 0.645833*global.atk_wingman;break;
			}
