...
damage = 0.75/6*5
switch(weapon_level){
	case 0:damage = 0.75/6*5*global.atk_subweapon;break;
	case 1:damage = 0.8125/6*5*global.atk_subweapon;break;
	case 2:damage = 0.85/6*5*global.atk_subweapon;break;
	case 3:damage = 0.75/6*5*global.atk_subweapon;break;
}
