live;
blt = MakePlayerBullet(x,y-10*scale_y,bullet_player_nuke,seq_nuke_b_rampage_intro)
blt.idle = seq_nuke_b_rampage
blt.collision_effect_sequence = seq_nuke_b_explosion
blt.collision_effect_duration = 12;
