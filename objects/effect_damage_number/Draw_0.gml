...
// 6. 绘制图标（左侧）
draw_sprite_ext(spr_icon, 0,base_x, base_y,scale, scale,0, -1, image_alpha);

// 7. 绘制数字（右侧）
draw_text_ext_transformed_color(base_x + iw * scale+1,base_y-15*scale,str,0, 999,scale, scale,0,0,0,0,0,image_alpha);
draw_text_ext_transformed_color(base_x + iw * scale-1,base_y-15*scale,str,0, 999,scale, scale,0,0,0,0,0,image_alpha);
draw_text_ext_transformed_color(base_x + iw * scale,base_y-15*scale+1,str,0, 999,scale, scale,0,0,0,0,0,image_alpha);
draw_text_ext_transformed_color(base_x + iw * scale,base_y-15*scale-1,str,0, 999,scale, scale,0,0,0,0,0,image_alpha);
draw_text_ext_transformed_color(base_x + iw * scale,base_y-15*scale,str,0, 999,scale, scale,0,-1,-1,-1,-1,image_alpha);
