...
a.damage_interval -= 3
a.damage = damage
a = MakePlayerBullet(x-34*scale_x,y+30*scale_y,bullet_player_plane_xeno_d,seq_bullet_player_xeno_d_rampage)
a.vspeed = -21.5*2
a.rampage = true
a.damage_interval -= 2
a.damage = damage
...
a.damage_interval -= 2
a.damage = damage
a = MakePlayerBullet(x-45*scale_x,y+45*scale_y,bullet_player_plane_xeno_d,seq_bullet_player_xeno_d_rampage)
a.vspeed = -16*2
a.rampage = true
a.damage_interval -= 1
a.damage = damage
