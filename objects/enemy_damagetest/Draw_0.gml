...
draw_text_transformed(x,y-20,"dps:"+string_format(current_dps,0,4),1,1,0)
draw_text_transformed(x,y+20,"average dps:"+string_format(tdps/ds_list_size(dpss),0,4),1,1,0)
