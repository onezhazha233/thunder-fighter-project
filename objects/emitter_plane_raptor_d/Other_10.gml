...
a.damage = damage
if(weapon_level > 0){
	a = MakePlayerBullet(x-22*scale_x,y+15*scale_y,bullet_player_plane_raptor_d,seq_bullet_player_raptor_d);
	a.vspeed = -22.5;
	a.damage = damage;
	a = MakePlayerBullet(x+22*scale_x,y+15*scale_y,bullet_player_plane_raptor_d,seq_bullet_player_raptor_d);
	a.vspeed = -22.5;
...
if(weapon_level > 1){
	a = MakePlayerBullet(x-34*scale_x,y+30*scale_y,bullet_player_plane_raptor_d,seq_bullet_player_raptor_d);
	a.vspeed = -28;
	a.damage = damage;
	a = MakePlayerBullet(x+34*scale_x,y+30*scale_y,bullet_player_plane_raptor_d,seq_bullet_player_raptor_d);
	a.vspeed = -28;
