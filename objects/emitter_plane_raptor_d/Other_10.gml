...
if(weapon_level > 0&&bb mod 4 = 2){
	a = MakePlayerBullet(x-22*scale_x,y+15*scale_y,bullet_player_plane_raptor,seq_bullet_player_raptor_d);
	a.sprite_index = spr_bullet_player_raptor_d;
	a.vspeed = -22.5;
	a.damage = damage;
	a = MakePlayerBullet(x+22*scale_x,y+15*scale_y,bullet_player_plane_raptor,seq_bullet_player_raptor_d);
...
if(weapon_level > 1&&bb mod 4 = 1){
	a = MakePlayerBullet(x-34*scale_x,y+30*scale_y,bullet_player_plane_raptor,seq_bullet_player_raptor_d);
	a.sprite_index = spr_bullet_player_raptor_d;
	a.vspeed = -28;
	a.damage = damage;
	a = MakePlayerBullet(x+34*scale_x,y+30*scale_y,bullet_player_plane_raptor,seq_bullet_player_raptor_d);
...
if(weapon_level > 2&&bb mod 4 = 0){
	a = MakePlayerBullet(x-45*scale_x,y+45*scale_y,bullet_player_plane_raptor,seq_bullet_player_raptor_d);
	a.sprite_index = spr_bullet_player_raptor_d;
	a.vspeed = -33.5;
	a.damage = damage;
	a = MakePlayerBullet(x+45*scale_x,y+45*scale_y,bullet_player_plane_raptor,seq_bullet_player_raptor_d);
