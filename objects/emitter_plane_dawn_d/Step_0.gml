...
if(enabled = true){
	...
	if(time mod 5 = 1){
		...
		damage = 0.521;
		switch(weapon_level){
			case 0:damage = 0.1302*global.atk_plane;break;
			case 1:damage = 0.1302*1.3*global.atk_plane;break;
			case 2:damage = 0.1302*1.7*global.atk_plane;break;
			case 3:damage = 0.1302*2*global.atk_plane;break;
		}
		...
		a.speed = spd;
		a.damage = damage;
		a = MakePlayerBullet(x-25*scale_x,y-30*scale_y,bullet_player_plane_dawn_small);
		a.sprite_index = spr_bullet_player_dawn_d_small;
		a.collision_effect_sequence = seq_bullet_effect_dawn_d;
		a.image_index = 1;
		a.direction = 90+7;
		...
		a.speed = spd;
		a.damage = damage;
		a = MakePlayerBullet(x-35*scale_x,y-30*scale_y,bullet_player_plane_dawn_small);
		a.sprite_index = spr_bullet_player_dawn_d_small;
		a.collision_effect_sequence = seq_bullet_effect_dawn_d;
		a.image_index = 1;
		a.direction = 90+12;
		...
		a.damage = damage;
		if(weapon_level > 0){
			a = MakePlayerBullet(x-43*scale_x,y-30*scale_y,bullet_player_plane_dawn_small);
			a.sprite_index = spr_bullet_player_dawn_d_small;
			a.collision_effect_sequence = seq_bullet_effect_dawn_d;
			a.image_index = 1;
			a.direction = 90+18;
		...
		if(weapon_level > 1){
			a = MakePlayerBullet(x-50*scale_x,y-15*scale_y,bullet_player_plane_dawn_small);
			a.sprite_index = spr_bullet_player_dawn_d_small;
			a.collision_effect_sequence = seq_bullet_effect_dawn_d;
			a.direction = 90+25;
			a.image_angle = 25;
