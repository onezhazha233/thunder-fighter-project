...
if(time mod 5 = 1){
	...
	a.speed = spd;
	a.damage = damage;
	a = MakePlayerBullet(x-20*scale_x,y-50,bullet_player_plane_dawn_a_small);
	a.sprite_index = spr_bullet_player_dawn_d_small;
	a.image_index = 2;
	a.direction = 90+3;
	a.image_angle = 3;
	...
	a.speed = spd;
	a.damage = damage;
	a = MakePlayerBullet(x-25*scale_x,y-30,bullet_player_plane_dawn_a_small);
	a.sprite_index = spr_bullet_player_dawn_d_small;
	a.image_index = 1;
	a.direction = 90+7;
	a.image_angle = 7;
	...
	a.speed = spd;
	a.damage = damage;
	a = MakePlayerBullet(x-35*scale_x,y-30,bullet_player_plane_dawn_a_small);
	a.sprite_index = spr_bullet_player_dawn_d_small;
	a.image_index = 1;
	a.direction = 90+12;
	a.image_angle = 12;
	...
	a.damage = damage;
	if(weapon_level > 0){
		a = MakePlayerBullet(x-43*scale_x,y-30,bullet_player_plane_dawn_a_small);
		a.sprite_index = spr_bullet_player_dawn_d_small;
		a.image_index = 1;
		a.direction = 90+18;
		a.image_angle = 18;
	...
	if(weapon_level > 1){
		a = MakePlayerBullet(x-50*scale_x,y-15,bullet_player_plane_dawn_a_small);
		a.sprite_index = spr_bullet_player_dawn_d_small;
		a.direction = 90+25;
		a.image_angle = 25;
		a.speed = spd;
	...
	if(weapon_level > 2){
		a = MakePlayerBullet(x-65*scale_x,y,bullet_player_plane_dawn_a_small);
		a.sprite_index = spr_bullet_player_dawn_d_small;
		a.direction = 90+33;
		a.image_angle = 33;
		a.speed = spd;
