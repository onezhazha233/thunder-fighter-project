...
if(instance_exists(find[1])){
	...
	draw_sprite_ext(spr_bullet_effect_mega_ab,0,ex,ey,image_xscale*scale_x*choose(1,-1)/0.8,image_yscale*scale_y*image_xscale/0.8,choose(0,180),-1,image_alpha);
}