...
if!(instance_exists(follow_inst[0,0])){
	...
	laser[0].laser_sprite = spr_bullet_player_refraction_rampage;
	laser[0].offset_speed = 60;
...
if!(instance_exists(follow_inst[1,0])){
	...
	laser[1].laser_sprite = spr_bullet_player_refraction_rampage;
	laser[1].offset_speed = 60;
