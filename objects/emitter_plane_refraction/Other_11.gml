...
if!(instance_exists(follow_inst[0,0])){
	...
	laser.laser_sprite = spr_bullet_player_phantom_a_rampage;
	laser.offset_speed = 45;
	laser.damage = damage;
	...
	if!(follow_inst[0,0].laser_sprite = spr_bullet_player_phantom_a_rampage){
		follow_inst[0,0].laser_sprite = spr_bullet_player_phantom_a_rampage;
	}
	follow_inst[0,0].offset_speed = 45;
...
if!(instance_exists(follow_inst[1,0])){
	...
	if!(follow_inst[1,0].laser_sprite = spr_bullet_player_phantom_a_rampage){
		follow_inst[1,0].laser_sprite = spr_bullet_player_phantom_a_rampage;
	}
	follow_inst[1,0].offset_speed = 45;
