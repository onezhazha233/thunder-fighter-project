...
function drone_add(){
	var new_drone = instance_create_depth(x,y,depth+10,emitter_plane_overwatcher_drone_b_0);
...
function drone_1_create(){
	...
	for(var side = 0; side < 2; side++){
		...
		for(var i = 0; i < drone_1_number; i++){
			var inst = instance_create_depth(x,y,depth+10,emitter_plane_overwatcher_drone_b_1);
...
function drone_2_create(){
	...
	for(var side = 0; side < 2; side++){
		...
		for(var i = 0; i < drone_2_number; i++){
			var inst = instance_create_depth(x,y,depth+10,emitter_plane_overwatcher_drone_b_2);
