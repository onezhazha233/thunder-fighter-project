...
boss = {
	...
	Create : function(){
		enemy[0] = instance_create_depth(room_width/2-100,-200,DEPTH_BATTLE.ENEMIES,boss_twin_0);
		enemy[1] = instance_create_depth(room_width/2+100,-200,DEPTH_BATTLE.ENEMIES,boss_twin_1);
		return enemy;
	}
}
