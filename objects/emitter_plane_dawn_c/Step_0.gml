...
if(enabled = true){
	...
	if(time mod 5 = 1){
		...
		blt.sprite_index = spr_bullet_player_dawn_c_small;
		...
		blt.speed = spd;
		blt.damage = damage;
		blt = MakePlayerBullet(x-30*scale_x,y-40*scale_y,bullet_player_plane_dawn_small);
		blt.sprite_index = spr_bullet_player_dawn_c_small;
		blt.collision_effect = seq_bullet_effect_dawn_c;
		blt.image_index = 1;
		blt.direction = 90+10;
		...
		blt.damage = damage;
		if(weapon_level > 0){
			blt = MakePlayerBullet(x-40*scale_x,y-40*scale_y,bullet_player_plane_dawn_small);
			blt.sprite_index = spr_bullet_player_dawn_c_small;
			blt.collision_effect = seq_bullet_effect_dawn_c;
			blt.image_index = 1;
		...
		if(weapon_level > 1){
			blt = MakePlayerBullet(x-52*scale_x,y-25*scale_y,bullet_player_plane_dawn_small);
			blt.sprite_index = spr_bullet_player_dawn_c_small;
			blt.collision_effect = seq_bullet_effect_dawn_c;
			blt.direction = 90+22;
			blt.image_angle = 22;
