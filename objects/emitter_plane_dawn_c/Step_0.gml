...
if(time mod 5 = 1){
	...
	a.speed = spd;
	a.damage = damage;
	a = MakePlayerBullet(x-30*scale_x,y-40,bullet_player_plane_dawn_a_small);
	a.sprite_index = spr_bullet_player_dawn_c_small;
	a.image_index = 1;
	a.direction = 90+10;
	a.image_angle = 10;
	...
	a.damage = damage;
	if(weapon_level > 0){
		a = MakePlayerBullet(x-40*scale_x,y-40,bullet_player_plane_dawn_a_small);
		a.sprite_index = spr_bullet_player_dawn_c_small;
		a.image_index = 1;
		a.direction = 90+15.5;
		a.image_angle = 15.5;
	...
	if(weapon_level > 1){
		a = MakePlayerBullet(x-52*scale_x,y-25,bullet_player_plane_dawn_a_small);
		a.sprite_index = spr_bullet_player_dawn_c_small;
		a.direction = 90+22;
		a.image_angle = 22;
		a.speed = spd;
