...
enemy_1 = new Enemy(enemy_og0c0,emitter_enemy_og0c0,function(){
	EnemyMove_Pre([820, 480], [360, 480], 40);
	EnemyMove_Intro(60);
	EnemyMove_LoopEllipse(400, 360, 3, 0, 150,300);
});

enemy_2 = new Enemy(enemy_og0c1,emitter_enemy_og0c1,function(){
	EnemyMove_Pre([-100, 320], [160, 320], 40);
	EnemyMove_Intro(60);
	EnemyMove_LoopEllipse(400, 360, 2, 0, 120,300);
});

enemy_3 = new Enemy(enemy_og0c1,emitter_enemy_og0c1,function(){
