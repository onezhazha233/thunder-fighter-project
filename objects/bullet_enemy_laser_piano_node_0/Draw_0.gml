...
if(state < 2){
	...
	draw_sprite_ext(spr_bullet_enemy_laser_piano_node_0_bg,0,x,y,node_0_scale,node_0_scale,0,-1,node_0_alpha);
	if(node_part = 1){
	...
	draw_sprite_ext(spr_bullet_enemy_laser_piano_node_0,1,x,y,node_1_scale,node_1_scale,0,-1,node_1_alpha);
	draw_sprite_ext(spr_bullet_enemy_laser_piano_node_0,0,x,y,node_0_scale,node_0_scale,0,-1,node_0_alpha);
}