...
if(time mod 5 = 1){
	...
	a.damage = damage;
	if(weapon_level > 0){
		a = MakePlayerBullet(x-35*scale_x,y-40,bullet_player_plane_dawn_a_small);
		a.sprite_index = spr_bullet_player_dawn_b_small;
		a.image_index = 1;
		a.direction = 90+12.5;
		a.image_angle = 12.5;
	...
	if(weapon_level > 1){
		a = MakePlayerBullet(x-50*scale_x,y-25,bullet_player_plane_dawn_a_small);
		a.sprite_index = spr_bullet_player_dawn_b_small;
		a.direction = 90+20;
		a.image_angle = 20;
		a.speed = spd;
