...
if(rampage = false){
	...
	draw_sprite_ext(spr_bullet_player_phantom_a_start_rampage,fire_image,x+lengthdir_x(-20,image_angle)*scale_x,y+lengthdir_y(-20,image_angle)*scale_y,0.88-sin(fire_image*(2*pi/3))*0.12*scale_x,1.6+sin(fire_image*(2*pi/3))*0.2*scale_y,image_angle-90,-1,1);
}
...
if(instance_exists(find_enemy)){
	...
	draw_sprite_ext(spr_bullet_effect_phantom_a,0,ex,ey,effect_xscale*image_xscale*scale_x,effect_yscale*image_xscale*scale_y,0,-1,1);
